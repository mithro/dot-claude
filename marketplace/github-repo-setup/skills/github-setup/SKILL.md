---
name: github-setup
description: Use when creating or configuring new GitHub repositories. Applies standard repository settings including branch protection, merge options, security scanning, tag rulesets, and more via GitHub CLI commands.
version: 1.0.0
---
